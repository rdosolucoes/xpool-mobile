...
class FilterPartnershipShopStore
    extends MobXStore<Failure, FilterPartnershipShopEntity> {
  FilterPartnershipShopStore()
      : super(FilterPartnershipShopEntity(filterneeds: [], needs: []));
