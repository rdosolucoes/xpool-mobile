...
class NotificationShopStore extends MobXStore<Failure, NotificationShopVM> {
  NotificationShopStore() : super(NotificationShopVM());
  ...
  void setNotifications(
      Future<Either<Failure, List<NotificationShopEntity>>> value) async {
    setLoading(true);
