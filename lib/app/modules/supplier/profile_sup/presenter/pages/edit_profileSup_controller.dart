...
class EditProfileSupController {
  final ProfileSupStore store;
  final PostProfileSup _postProfile;
  final AuthStore _authStore;
  final IAuthLocalStorage _localStorage;

  EditProfileSupController(
  ...
  Future<String?> uploadImageToAzure(XFile? pickedFile) async {
    try {
      ...
      print(ex.message);
      return "$baseUrlStorage/images/noimage_sup.jpg";
    }
    return null;
  }

  Future<void> save(ProfileSupEntity model) async {
